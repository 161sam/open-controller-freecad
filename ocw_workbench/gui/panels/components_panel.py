...
def _build_form() -> dict[str, Any]:
    ...
    selector_actions.setHorizontalSpacing(8)
    ...
    selector_actions.addWidget(snap_button, 0, 2)
    selector_actions.addWidget(reset_button, 0, 3)
    ...
    top_row.addWidget(selector_box, 2)
    top_row.addWidget(add_box, 1)
